...
QString QStandardPaths::writableLocation(StandardLocation type)
{
    ...
    case DesktopLocation:
        return QDir::homePath() + QStringLiteral("/Desktop");
    case DocumentsLocation:
        return QDir::homePath() + QStringLiteral("/Documents");
    case PicturesLocation:
        return QDir::homePath() + QStringLiteral("/Pictures");
    case FontsLocation:
        return QStringLiteral("/boot/system/data/fonts/ttfonts");
    case MusicLocation:
        return QDir::homePath() + QStringLiteral("/Music");
    case MoviesLocation:
        return QDir::homePath() + QStringLiteral("/Videos");
